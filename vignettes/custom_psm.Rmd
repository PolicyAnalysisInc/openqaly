...
discontinuation_model <- define_model("custom_psm") |>
  ...
  # Groups
  add_group("all", display_name = "All Patients") |>
...
```{r disc-table}
outcomes_table(disc_results, outcome = "total_cost")
```
...
```{r response-table}
outcomes_table(response_results, outcome = "total_cost")
```
