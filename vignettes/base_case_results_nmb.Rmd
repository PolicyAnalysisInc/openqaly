...
The openqaly package provides flexible tools for creating publication-ready plots and tables.
...
The openqaly package provides two main plot types for net monetary benefit:
