...
The `dsa_ce_plot()` function creates tornado plots showing the impact of parameter variations on the Incremental Cost-Effectiveness Ratio (ICER).
...
The `dsa_ce_table()` function presents ICER sensitivity results in tabular format.
