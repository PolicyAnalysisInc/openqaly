...
model <- model %>%
  ...
  add_scenario_variable("High Cost", "c_treatment", 15000, strategy = "seritinib") %>%
  ...
  add_scenario_variable("Low Cost", "c_treatment", 2000, strategy = "seritinib") %>%
  ...
  add_scenario_variable("Best Case", "c_treatment", 1500, strategy = "seritinib") %>%
  ...
  add_scenario_variable("Worst Case", "c_treatment", 20000, strategy = "seritinib") %>%
...
Use `scenario_costs_plot()` to create bar charts for cost outcomes with currency formatting:

```{r, fig.width = 7, fig.height = 5}
scenario_costs_plot(results, "costs")
```

#### Showing Differences

```{r, fig.width = 7, fig.height = 5}
scenario_costs_plot(results, "costs", comparators = "volantor")
```
...
```{r}
scenario_costs_table(results, "costs")
```
...
```{r, fig.width = 7, fig.height = 6}
scenario_costs_plot(results, "costs", groups = "all")
```
