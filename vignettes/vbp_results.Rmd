...
### Excluding the "All Comparators" column
...
### The "All Comparators" column

When there are multiple comparator strategies, the "All Comparators" column in VBP tables shows the **minimum VBP across all comparators** at each WTP threshold. This represents the price that ensures cost-effectiveness versus **all** alternatives simultaneously - the most conservative pricing recommendation.
...
4. The "All Comparators" value provides the safest pricing target when multiple alternatives exist
